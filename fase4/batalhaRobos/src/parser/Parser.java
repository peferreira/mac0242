...
// Programa � o ponto de partida  final public Instrucao [ ] Programa() throws ParseException {
  ...
  final public Vector < Instrucao > Comando() throws ParseException {
...
// No n�vel mais baixo calcula as express�es l�gicas e realiza as op�ra��es especiais  final public Vector < Instrucao > Expressao() throws ParseException {
  Vector < Instrucao > p = new Vector < Instrucao > (0);
  Vector < Instrucao > x = new Vector < Instrucao > (0);
    if (jj_2_15(2)) {
      x = Arit();
...
// Artim�ticas  final public Vector < Instrucao > Arit() throws ParseException {
  ...
  final public Vector < Instrucao > Termo() throws ParseException {
  Vector < Instrucao > p = new Vector < Instrucao > (0);
  Vector < Instrucao > x = new Vector < Instrucao > (0);
    x = Fator();
    p.addAll(x);
  ...
  final public Vector < Instrucao > Fator() throws ParseException {
  Vector < Instrucao > p = new Vector < Instrucao > (0);
  Vector < Instrucao > x = new Vector < Instrucao > (0);
  Token t;
  Simbolo v;
    ...
    { // existe como global?
      ...
      else p.add(new PRN()); // colocar erro de compila��o aqui
    }
    else
  ...
  final public Vector < Instrucao > Condicional() throws ParseException {
  Vector < Instrucao > p = new Vector < Instrucao > (0);
  Vector < Instrucao > x = new Vector < Instrucao > (0);
  int delta, pos;
    if (jj_2_42(2)) {
...
// Um �tem a ser impresso  final public Vector < Instrucao > ItemPrint() throws ParseException {
  ...
  Token t;
    if (jj_2_55(2)) {
      ...
      while (s.contains("\u005c\u005ct")) s = s.replace("\u005c\u005ct", "\u005ct");
