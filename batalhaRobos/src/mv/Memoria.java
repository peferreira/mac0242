...
public class Memoria {
	...
	try {
	    ...
	    System.out.println("setMemoria: O endereço " + ((Endereco)indice).getEndereco() + " está fora da memória alocada!");
	    System.exit(1);
	}
    }
	...
	try {
	    ...
	    System.out.println("getMemoria: O endereço " + ((Endereco)endereco).getEndereco() + " está fora da memória alocada!");
	    System.exit(1);
	}
	return item;
    }
