...
public class Programas {
	...
	public void testaMoveEast() {
		Programa prg1 = new Programa();

		prg1.addInstrucao(new PUSH(new Direcao("EAST")));
		prg1.addInstrucao(new MOVE());
		prg1.addInstrucao(new PUSH(new Direcao("SEAST")));
		prg1.addInstrucao(new MOVE());
		prg1.addInstrucao(new PUSH(new Direcao("WEST")));
		prg1.addInstrucao(new MOVE());
		prg1.addInstrucao(new PUSH(new Direcao("NWEST")));
		prg1.addInstrucao(new MOVE());
		prg1.addInstrucao(new END());
